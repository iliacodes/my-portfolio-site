...
const ExperienceCard = ({ experience }) => (
  <VerticalTimelineElement
    contentStyle={{ background: "#072A24", color: "#8DB6A8" }}
  ...
  >
    <div>
      ...
      <p className="text-[#8DB6A8] text-[24px] font-semibold" style={{ margin: 0 }}>{experience.company_name}</p>
    </div>
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className="sm:text-[18px] text-[14px] text-[#D2E2DF] uppercase tracking-wider">Journey so far.</p>
